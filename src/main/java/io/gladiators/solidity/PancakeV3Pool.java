...
public class PancakeV3Pool extends Contract {
    ...
    public static final String FUNC_LMPOOL = "lmPool";
    ...
    public static final Event SETLMPOOLEVENT_EVENT = new Event("SetLmPoolEvent", 
            Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
    ;

    public static final Event SWAP_EVENT = new Event("Swap", 
            Arrays.<TypeReference<?>>asList(new TypeReference<Address>(true) {}, new TypeReference<Address>(true) {}, new TypeReference<Int256>() {}, new TypeReference<Int256>() {}, new TypeReference<Uint160>() {}, new TypeReference<Uint128>() {}, new TypeReference<Int24>() {}, new TypeReference<Uint128>() {}, new TypeReference<Uint128>() {}));
    ;

    @Deprecated
    protected PancakeV3Pool(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected PancakeV3Pool(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected PancakeV3Pool(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected PancakeV3Pool(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public static List<SetLmPoolEventEventResponse> getSetLmPoolEventEvents(TransactionReceipt transactionReceipt) {
        List<EventValuesWithLog> valueList = staticExtractEventParametersWithLog(SETLMPOOLEVENT_EVENT, transactionReceipt);
        ArrayList<SetLmPoolEventEventResponse> responses = new ArrayList<SetLmPoolEventEventResponse>(valueList.size());
        for (EventValuesWithLog eventValues : valueList) {
            SetLmPoolEventEventResponse typedResponse = new SetLmPoolEventEventResponse();
            typedResponse.log = eventValues.getLog();
    ...
    public Flowable<SetLmPoolEventEventResponse> setLmPoolEventEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new Function<Log, SetLmPoolEventEventResponse>() {
            @Override
            public SetLmPoolEventEventResponse apply(Log log) {
                EventValuesWithLog eventValues = extractEventParametersWithLog(SETLMPOOLEVENT_EVENT, log);
                SetLmPoolEventEventResponse typedResponse = new SetLmPoolEventEventResponse();
                typedResponse.log = log;
                typedResponse.addr = (String) eventValues.getNonIndexedValues().get(0).getValue();
                return typedResponse;
    ...
    public Flowable<SetLmPoolEventEventResponse> setLmPoolEventEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(SETLMPOOLEVENT_EVENT));
        return setLmPoolEventEventFlowable(filter);
    }
    ...
    public static List<SwapEventResponse> getSwapEvents(TransactionReceipt transactionReceipt) {
        ...
        for (EventValuesWithLog eventValues : valueList) {
            ...
            typedResponse.protocolFeesToken0 = (BigInteger) eventValues.getNonIndexedValues().get(5).getValue();
            typedResponse.protocolFeesToken1 = (BigInteger) eventValues.getNonIndexedValues().get(6).getValue();
            responses.add(typedResponse);
        }
        return responses;
    }
    ...
    public RemoteFunctionCall<String> lmPool() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_LMPOOL, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }
    ...
    public RemoteFunctionCall<TransactionReceipt> setFeeProtocol(BigInteger feeProtocol0, BigInteger feeProtocol1) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_SETFEEPROTOCOL, 
                Arrays.<Type>asList(new Uint32(feeProtocol0),
                new Uint32(feeProtocol1)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteFunctionCall<TransactionReceipt> setLmPool(String _lmPool) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_SETLMPOOL, 
                Arrays.<Type>asList(new Address(160, _lmPool)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<Tuple7<BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, Boolean>> slot0() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_SLOT0, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint160>() {}, new TypeReference<Int24>() {}, new TypeReference<Uint16>() {}, new TypeReference<Uint16>() {}, new TypeReference<Uint16>() {}, new TypeReference<Uint32>() {}, new TypeReference<Bool>() {}));
    ...
    @Deprecated
    public static PancakeV3Pool load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new PancakeV3Pool(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static PancakeV3Pool load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new PancakeV3Pool(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static PancakeV3Pool load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new PancakeV3Pool(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static PancakeV3Pool load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new PancakeV3Pool(contractAddress, web3j, transactionManager, contractGasProvider);
    }
    ...
    public static class SetLmPoolEventEventResponse extends BaseEventResponse {
        public String addr;
    }
    ...
    public static class SwapEventResponse extends BaseEventResponse {
        ...
        public BigInteger protocolFeesToken0;

        public BigInteger protocolFeesToken1;
    }
}
