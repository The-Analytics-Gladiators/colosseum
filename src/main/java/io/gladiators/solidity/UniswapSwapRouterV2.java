...
public class UniswapSwapRouterV2 extends Contract {
    ...
    @Deprecated
    protected UniswapSwapRouterV2(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected UniswapSwapRouterV2(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected UniswapSwapRouterV2(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected UniswapSwapRouterV2(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public RemoteFunctionCall<TransactionReceipt> multicall(BigInteger deadline, List<byte[]> data, BigInteger weiValue) {
        final Function function = new Function(
                FUNC_multicall, 
                Arrays.<Type>asList(new Uint256(deadline),
                new org.web3j.abi.datatypes.DynamicArray<DynamicBytes>(
                        DynamicBytes.class,
                        org.web3j.abi.Utils.typeMap(data, DynamicBytes.class))),
                Collections.<TypeReference<?>>emptyList());
    ...
    @Deprecated
    public static UniswapSwapRouterV2 load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new UniswapSwapRouterV2(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static UniswapSwapRouterV2 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new UniswapSwapRouterV2(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static UniswapSwapRouterV2 load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new UniswapSwapRouterV2(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static UniswapSwapRouterV2 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new UniswapSwapRouterV2(contractAddress, web3j, transactionManager, contractGasProvider);
    }
